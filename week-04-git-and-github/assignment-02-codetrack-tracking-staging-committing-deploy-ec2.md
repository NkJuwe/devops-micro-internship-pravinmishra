...
![CodeTrack](<Screenshot 2026-07-22 014015.png>)

---

#### Screenshot 2 — Output of `git status` showing no "not a git repository" error

![git status](<Screenshot 2026-07-22 020033.png>)
...
![index.html style.css](<Screenshot 2026-07-22 014658.png>)
...
![editor](<Screenshot 2026-07-22 013537.png>)
...
![untracked](<Screenshot 2026-07-22 014138.png>)

---

#### Screenshot 6 — Output of `git status` showing both files staged under "Changes to be committed"

![staged files](<Screenshot 2026-07-22 014918.png>)
...
![git commit](<Screenshot 2026-07-22 015107.png>)

---

#### Screenshot 8 — Output of `git log --oneline` showing the first commit

![first commit](<Screenshot 2026-07-22 015139.png>)
...
![Browser](<Screenshot 2026-07-22 095518.png>)

---

#### Screenshot 10 — Output of `git status` showing `index.html` as modified

![modified](<Screenshot 2026-07-22 020059.png>)

---

#### Screenshot 11 — Output of `git commit`

![commit](<Screenshot 2026-07-22 020459.png>)

---

#### Screenshot 12 — Output of `git log --oneline` showing two commits

![git log](<Screenshot 2026-07-23 142612.png>)
...
![nginx](<Screenshot 2026-07-22 094718.png>)

---

#### Screenshot 14 — Output of `curl -I http://localhost` showing `HTTP/1.1 200 OK`

![curl-I](<Screenshot 2026-07-22 100001.png>)
...
https://www.linkedin.com/posts/nkechi-juwe_dmibypravinmishra-agenticai-claudecode-ugcPost-7486066367780265984-bxJD/?utm_source=share&utm_medium=member_desktop&rcm=ACoAADt-vqsBoRObYmV0maWpD3wnWmjrlXVSF4M

---

#### Screenshot — LinkedIn post showing the deployed CodeTrack application

![linkedin](<Screenshot 2026-07-23 153652.png>)
